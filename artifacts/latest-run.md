...
## Task results
- support-batch | support | deterministic-echo-v1 | completed | classifier:task-classifier, formatter:structured-output-formatter
  ...
  Approval: approved by support-reviewer (Automatically approved from CLI flag.)
...
## Approvals
- support-batch | approved | support-reviewer | Automatically approved from CLI flag.
...
- approval.requested | support-manager | Human review required before customer-facing response
- approval.approved | support-reviewer | Automatically approved from CLI flag.
